...
PPP*)
  ...
  output_line "ppp0" "<b>WAN1</b>" "$INTERNET_TYPE" "$LINET_UP" "$PPPIP [ <a href=dial-ppp.cgi><u>$Mdl</u></a> | <a href=hangup-ppp.cgi><u>$Mhg</u></a> ]" "$GW [ <a href=diags.cgi?COMMAND=/usr/sbin/gateway.test><u>$Abf</u></a> ]" "$CONNECTTIME" "$CONNECTSTRING"
  end_table
  echo "<br>"
#  init_main_table
#  add_title "$Ani" "5"
...
[ "$INETTYPE" = "ETHERNET_STATIC"  ] && end_table
#DNS
